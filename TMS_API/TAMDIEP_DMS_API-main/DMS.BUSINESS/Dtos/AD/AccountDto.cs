...
namespace DMS.BUSINESS.Dtos.AD
{
    public class AccountDto : BaseAdDto, IMapFrom, IDto
    {
        ...
        [JsonIgnore]
        public virtual List<AccountSaleOfficeDto> AccountSaleOffices { get; set; }

        public virtual List<PartnerSaleOfficeDto> Partners { get => AccountSaleOffices.Select(x => x.Partner).ToList(); }
