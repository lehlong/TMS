...
namespace DMS.API.Controllers.MD
{
    ...
    [ApiController]
    public class VehicleTypeController(IVehicleTypeService service) : ControllerBase
    {
        public readonly IVehicleTypeService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] VehicleTypeDto VehicleType)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] VehicleTypeDto VehicleType)
        {
            var transferObject = new TransferObject();
