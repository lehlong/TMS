...
namespace DMS.API.Controllers.MD
{
    ...
    public class VehicleController(IVehicleService service) : ControllerBase
    {
        ...
        [HttpGet("GetAll")]
        public async Task<IActionResult> GetAll([FromQuery] VehicleGetAllFilter filter)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] VehicleCreateUpdateDto model)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] VehicleCreateUpdateDto model)
        {
            var transferObject = new TransferObject();
